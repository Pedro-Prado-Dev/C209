'''
Funções usadas para ler e codificar uma imagem
...
"""
----------------------------------DCT/IDCT-------------------------------------
Multiplicação por uma matriz para converter amplitude espacial em frêquencia
"""
def dct2(bloc):
...
"""
---------------------------------COD JPEG--------------------------------------
Codificação de uma imagem JPEG colorida para uma imagem em tons de cinza.
Attributes:
    Image's name
...
def Cod_Imatge_DCT(imatge,Q,k):
    ...
    img_dividida = []
    y = 0 #[0,0]
    for i in range(8,altura+1,8): #Take the values in each 8-pixel step
        x = 0
        for j in range(8,largura+1,8):
